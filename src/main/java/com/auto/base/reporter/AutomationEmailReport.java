...
import com.auto.base.controller.Context;
 ...
 * </p>
 */
public class AutomationEmailReport implements IReporter {

	private static final Logger LOG = Logger.getLogger(AutomationEmailReport.class);
	...
	protected void writeReportTitle(String title) {
		writer.print(
				"<center><img src=\"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqkIKT8kzspbAjHfts4gVT9RbpJqc2rS--a2RbrvzqRD-HoLQj\"></center> <center><h1>"
	...
	protected void writeSuiteSummary() {
		...
		if (totalTests == totalSkippedTests) {
			...
			writer.print(
					"<br/><font color='red'><center><b><I>ALL TESTS SKIPPED DUE TO APPLICATION IS DOWN</I></b></<center></font>");

		}

		if (ContextManager.getGlobalContext() != null && ContextManager.getGlobalContext().getHostAddress() != null) {
			writer.print("<br/><font color='black'><center><b><I>** APPLICATION SERVER USED TO RUN TESTS #     '"
					+ ContextManager.getGlobalContext().getHostAddress() + "'</I></b></<center></font>");
		}
	...
	public List<MethodResult> removeFailedTest(List<MethodResult> methods) {
		...
		List<MethodResult> newMethods = new ArrayList<AutomationEmailReport.MethodResult>();
		int i = 0;
